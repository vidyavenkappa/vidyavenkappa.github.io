...
//       .then(res => res.json())
//       .then(data => {
//         const blog = data.find(post => post.id === id);
//         if (!blog) throw new Error('Blog not found');
//         setBlogMeta(blog);
//         return fetch(blog.contentFile);
//       })
//       .then(res => res.text())
//       .then(text => {
//         setContent(text);
...
//   if (loading) return <div className="blog-post-loading"><p>Loading...</p></div>;
//   if (error || !blogMeta) return (
//     <div className="blog-post-error">
//       <h2>{error}</h2>
...
//   return (
//     <section className="blog-post-section">
//       <div className="blog-post-header" style={{ backgroundImage: `url(${blogMeta.image})` }}>
//         <div className="overlay"></div>
//         <div className="container">
//           <div className="blog-post-meta">
//             <span>{blogMeta.category}</span>
